...
class LinkedBST(AbstractCollection):
    ...
    def isBalanced(self):
        ...
        :return:
        '''
        return self.height() <= ceil(log(len(self) + 1, 2))
    ...
    def successor(self, item):
        ...
        :rtype:
        """
        large_list = [n for n in self.inorder() if n > item]
        if large_list is []:
            return None
    ...
    def predecessor(self, item):
        ...
        :rtype:
        """
        lit_list = [n for n in self.inorder() if n < item]
        if lit_list is []:
            return None
        return max(lit_list)